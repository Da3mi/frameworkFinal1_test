...
public class OColumn {
    ...
    OFieldsHelper.ValueWatcher mValueWatcher = null;
     ...
     *
     * @param label          the label
     * @param class_instance the class_instance
     */
     ...
     * @param label          the label
     * @param class_instance the class_instance
     * @param relation_type  the relation_type
     */
    public OColumn(String label, Class<?> class_instance,
     ...
     * @param class_instance the class_instance
     * @param relation_type  the relation_type
     * @param related_column the related_column
     */
    public OColumn(String label, Class<?> class_instance,
     ...
     *
     * @param relation_type the new relation type
     */
     ...
     *
     * @param auto_incremnet the auto_incremnet
     * @return the o column
     */
     ...
     *
     * @param method the new functional method
     */
     ...
     * Sets the local column.
     *
     * @param local the new local column
     */
     ...
     * Adds the domain.
     *
     * @param condition_operator the condition_operator
     * @return the o column
     */
    ...
    public class ColumnDomain {
         ...
         *
         * @param conditional_operator the conditional_operator
         */
         ...
         *
         * @param conditional_operator the new conditional operator
         */
    ...
    /*/public OColumnDomain getColumnDomain() {
    ...
    public OFieldsHelper.ValueWatcher getmValueWatcher() {
        return mValueWatcher;
    }

    public void setmValueWatcher(OFieldsHelper.ValueWatcher mValueWatcher) {
