...
public class OSQLiteHelper extends SQLiteOpenHelper {
	...
	public List<OModel> baseModels() {
        ...
        models.add(new ResAppointment(mContext));
        models.add(new ResMedicament(mContext));
        models.add(new ResPrescription(mContext));
        models.add(new ResPatients(mContext));
        models.add(new ResPhysician(mContext));
        models.add(new MailGroupDB(mContext));
        models.add(new MessageDB(mContext));
		return models;
	}
