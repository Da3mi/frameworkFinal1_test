 ...
 */
public class MessageDetail extends BaseFragment implements View.OnClickListener {
    ...
    private View createListViewRow(View mView, final int position) {
        ...
        txvVoteNumber.setOnClickListener(new View.OnClickListener() {
        ...
        if (attachments != null && attachments.size() > 0) {
            ...
            OListAdapter mAttachmentGridAdapter = new OListAdapter(
                ...
                public View getView(final int position, View convertView,
                    ...
                    imgAttachmentImg.setOnClickListener(new View.OnClickListener() {
